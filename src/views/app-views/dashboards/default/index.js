...
import { Row, Col, Button, Avatar, Dropdown, Table, Menu, Tag, Card } from 'antd';
    ...
    <>  
      ...
      <Row gutter={16}>
        <Col xs={24} sm={24} md={24} lg={7}>
          <Card bordered={false} title="New Join Member" extra={<CardDropdown items={newJoinMemberOptions} />}>
            <div className="mt-3">
              {
        ...
        {/* <Col xs={24} sm={24} md={24} lg={17}>
          <Card bordered={false} title="Latest Transactions" extra={<CardDropdown items={latestTransactionOption} />}>
            <Table 

...
import { Row, Col, Button, Form, Select, InputNumber, Switch, Radio, Typography, Divider, Card, Tooltip, Tag, notification, Input, Space } from 'antd';
...
const AssignCredit = ({ id }) => {
  const { UserData, api, authToken, UserList, customStyles, formatAmountWithCommas, handleWhatsappAlert } = useMyContext();
  ...
  return (
    <Card title="Assign Credit" bordered={false} className="shadow-sm">
      <Row gutter={[24, 24]}>
        <Col xs={24} md={12}>
        ...
        <Card title="User Details" className="mt-4 shadow-sm">
          <Row gutter={[16, 16]}>
            <Col xs={24} md={6} className="text-center">
              <Typography.Text type="secondary" className="fs-14 d-block">
                <UserOutlined className="me-2" /> Name
              </Typography.Text>
            ...
            <Col xs={24} md={6} className="text-center">
              <Typography.Text type="secondary" className="fs-14 d-block">
                <PhoneOutlined className="me-2" /> Mobile Number
              </Typography.Text>
              <Typography.Title level={5} className="mt-2 mb-0">
            ...
            <Col xs={24} md={6} className="text-center">
              <Typography.Text type="secondary" className="fs-14 d-block">
                <WalletOutlined className="me-2" /> Current Balance
              </Typography.Text>
              <Typography.Title level={5} className="mt-2 mb-0 text-success">

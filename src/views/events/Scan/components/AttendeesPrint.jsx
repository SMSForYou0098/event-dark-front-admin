...
const AttendeesPrint = forwardRef(({
  ...
  const handleThermalPrint = useCallback(async () => {
    try {
      ...
      const tsplBytes = await generateTSPLCommands();
      await sendRawBytes(tsplBytes);
  ...
  }, [isConnected, connectionMode, connectUSB, connectBluetooth, generateTSPLCommands, sendRawBytes]);

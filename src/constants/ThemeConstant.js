...
export const HEADER_BG_DEFAULT_COLOR_DARK = 'rgb(255 255 255 / 6%) !important';
export const LAYOUT_CONTENT_GUTTER = 25;
export const LAYOUT_CONTENT_GUTTER_SM = 15;
// export const SIDE_NAV_DARK_BG_COLOR = '#001529'
export const SIDE_NAV_DARK_BG_COLOR = 'rgb(255 255 255 / 6%) !important';

export const BLUE_BASE= '#b51515';
